...
//		this.edges = new HashMap<>();
		this.edges = new TCharObjectHashMap<>();
...
//		Set<Character> nNextChars = n.nextChars();
        ...
        TCharSet mNextChars = m.nextChars();
        TCharSet nNextChars = n.nextChars();
...
//		allNextChars.addAll(nNextChars);
        TCharSet allNextChars = new TCharHashSet();
        allNextChars.addAll(mNextChars);
        allNextChars.addAll(nNextChars);
...
//		for (Character ch : allNextChars) {
        TCharIterator iterator = allNextChars.iterator();
...
//	public Set<Integer> search(final String q, int distance) {
	public TIntSet search(final String q, int distance) {
		Logger.increment();
...
//				Set<Integer> nodeValues = node.values;
				TIntSet nodeValues = node.values;
...
//					Set<Integer> endNodeValues = edge.getEndNode().values;
					TIntSet endNodeValues = edge.getEndNode().values;
...
//	public void addValues(Set<Integer> vs) {
	public void addValues(TIntSet vs) {
